...
export default function Layout({ children, currentPageName }) {
  ...
  const appPages = ["Partnerships", "Opportunities", "Recommendations", "Vendors", "Messages", "Forum", "PostDetail", "News", "Profile", "Settings", "ActivityFeed", "AdCampaigns", "Admin", "Connections"];
